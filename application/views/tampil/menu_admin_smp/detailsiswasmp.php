                      ...
                      <div class="tab-content">
                          <div class="active tab-pane" id="data_siswa">
                            <?php foreach ($detail1->result() as $d) { ?>
                              <form method="post" action="<?php echo base_url('siswa/siswasmp/updatedatasiswa') ?>" class="form-horizontal">
                                ...
                                <a href="<?php echo base_url('siswa/siswasmp'); ?>" type="button" class="btn btn-primary pull-center">Kembali</a>
                              </form>
                            <?php } ?>
                          <!-- Post -->
...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                          ...
                          <div class="tab-pane" id="data_keluarga">
                            <?php foreach ($detail2->result() as $dd) { ?>
                              <form method="post" action="<?php echo base_url('siswa/siswasmp/updatedatakeluarga') ?>" class="form-horizontal">
                                <div class="form-group">
                                  <label for="inputid" class="col-sm-2 control-label">ID Pendaftaran</label>
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" id="id" value="<?php echo $d->id_siswa; ?>" name="id" readonly>
...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                      ...
                      <div class="tab-pane" id="kandung">
                        <?php foreach ($detail3->result() as $ddd) { ?>
                          <form method="post" action="<?php echo base_url('siswa/siswasmp/updatedatakandung') ?>" class="form-horizontal">
                            <div class="form-group">
                              <label for="inputid" class="col-sm-2 control-label">ID Pendaftaran</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="id" value="<?php echo $d->id_siswa; ?>" name="id" readonly>
...
<!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                          ...
                          <div class="tab-pane" id="riwayat_kesehatan">
                            <?php foreach ($detail4->result() as $dddd){?>
                              <form method="post" action="<?php echo base_url('siswa/siswasmp/updatedatariwayatkesehatan') ?>" class="form-horizontal">
                                <div class="form-group">
                                  <label for="inputid" class="col-sm-2 control-label">ID Pendaftaran</label>
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" id="id" value="<?php echo $d->id_siswa; ?>" name="id" readonly>
...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                          <div class="tab-pane" id="ciri_khas_anak">
                            <?php foreach ($detail5->result() as $s){ ?>
                              <form method="post" action="<?php echo base_url('siswa/siswasmp/updatedatacirikhasanak') ?>" class="form-horizontal">
                                <div class="form-group">
                                  <label for="inputid" class="col-sm-2 control-label">ID Pendaftaran</label>
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" id="id" value="<?php echo $d->id_siswa; ?>" name="id" readonly>
