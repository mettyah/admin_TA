<div class="col-md-12">
    ...
    <form method="post" action="<?php echo base_url('verifikasi_awal/verifikasi_awal/proses_update_smp') ?>" class="form-horizontal">
        <div class="box-body">
...
// }
function back(param){
document.location='<?php echo base_url(); ?>verifikasi_awal/verifikasi_awal/pgsmp/'+param;
}
</script>
